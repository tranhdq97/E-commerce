    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT,
                                                     related_name=ec_base.common.constant.db_table.DBTable['ORDER'],
                                                     to='master.masterpaymentstatus')),
                ('shipping_status', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT,
                                                      related_name=ec_base.common.constant.db_table.DBTable['ORDER'],
                                                      to='master.mastershippingstatus')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT,
                                             related_name=ec_base.common.constant.db_table.DBTable['ORDER'],
